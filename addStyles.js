const bodyClass = "bg-green-800 bg-gradient-to-br from-orange-300 bg-opacity-50";
const bdy = document.querySelector('body');
bodyClass.split(" ").forEach((cls) => bdy.classList.add(cls));

const calBodyClass =
"max-w-lg rounded-3xl overflow-hidden shadow-2xl bg-orange-700 bg-opacity-75 bg-gradient-to-tr from-gray-700 flex";
